...
choice /C YN /M "Run npm install in discasa_app now"
...
if not exist "%ROOT_DIR%\start-app.bat" (
  echo Root app start script not found: %ROOT_DIR%\start-app.bat
  pause
  exit /b 1
)

echo.
echo Starting Discasa app from root launcher...
